                                    ...
                                    <TableRow key={user.id} className="transition-colors hover:bg-muted/50">
                                        ...
                                        <TableCell className="grid grid-cols-4 gap-x-3 gap-y-2">
                                            {user.roles.map((role: any) => (
                                                <span key={role.value} className="items-center whitespace-normal rounded bg-green-500/75 px-2.5 py-0.5 text-center text-xs font-semibold text-black">
                                                    {role.label}
                                                </span>
                                            ))}
                                        </TableCell>
