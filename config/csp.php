...
return [
    ...
    'policy' => [
        ...
        'script-src' => [
            'self',
            // Allow Vite's dev server in development
            ...(env('APP_ENV') === 'production' ? [] : ["'unsafe-inline'", 'http://127.0.0.1:5173']),
        ],
        'style-src' => [
            'self',
        ...
        'img-src' => [
            'self',
            // Add other image sources here, e.g., 'https://*.googleusercontent.com' for Google Cloud Storage
